export namespace EbsiConfig {
  export const DID_REGISTRY = 'https://api-pilot.ebsi.eu/did-registry/v3/identifiers'
  export const BASE_URL = 'https://api-pilot.ebsi.eu'
  export const TAR_REG = 'https://api-pilot.ebsi.eu/trusted-apps-registry/v3/apps'
}
